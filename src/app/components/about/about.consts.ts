export const listItems: any[] = [
    {
      title: 'Sarajevo, Bosnia and Herzegovina', iconClass: 'fa fa-map-marker'
    },
    {
...
export const aboutText2 =
 'I am looking for an innovative and user-centric company to best meet customer needs, from their idea to the final delivery of their project, or participate in the improvement of an existing project.'
